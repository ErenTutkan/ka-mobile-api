...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://ka-mobile-api.herokuapp.com/api') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://ka-mobile-api.herokuapp.com/api
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/v4.0.0.0/Javascript'
        };
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "https://ka-mobile-api.herokuapp.com/api",
