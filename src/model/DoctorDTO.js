...
/**
 * The DoctorDTO model module.
 * @module model/DoctorDTO
 * @version v4.0.0.7
 */
class DoctorDTO {
    /**
     * Constructs a new <code>DoctorDTO</code>.
     * @alias module:model/DoctorDTO
    ...
    /**
     * Constructs a <code>DoctorDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DoctorDTO} obj Optional instance to populate.
     * @return {module:model/DoctorDTO} The populated <code>DoctorDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DoctorDTO();
    ...
    /**
     * Validates the JSON data with respect to <code>DoctorDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DoctorDTO</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DoctorDTO.RequiredProperties) {
            if (!data[property]) {
...
DoctorDTO.RequiredProperties = ["id", "nameSurname", "title", "branch", "imagePath"];
