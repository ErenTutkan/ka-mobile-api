...
class RecipeDTO {
     ...
     * @param date {module:model/ModelDate} Visiting Date
     * @param medicines {Array.<Array>} Medicines Detail
     */
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('date')) {
                obj['date'] = ApiClient.convertToType(data['date'], ModelDate);
            }
            if (data.hasOwnProperty('medicines')) {
                obj['medicines'] = ApiClient.convertToType(data['medicines'], [Array]);
            }
        }
        return obj;
    }
