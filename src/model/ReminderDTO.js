...
class ReminderDTO {
     ...
     */
    constructor(medicineBarcode, medicineName, usageItemCount, usageHours, usageFrequency, reminderStartDate, reminderEndDate, tag, note) { 
        
        ReminderDTO.initialize(this, medicineBarcode, medicineName, usageItemCount, usageHours, usageFrequency, reminderStartDate, reminderEndDate, tag, note);
    }
     ...
     */
    static initialize(obj, medicineBarcode, medicineName, usageItemCount, usageHours, usageFrequency, reminderStartDate, reminderEndDate, tag, note) { 
...
ReminderDTO.RequiredProperties = ["medicineBarcode", "medicineName", "usageItemCount", "usageHours", "usageFrequency", "reminderStartDate", "reminderEndDate", "tag", "note"];
