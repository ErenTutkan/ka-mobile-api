...
class ReminderDTO {
     ...
     */
    constructor(medicineBarcode, medicineName, usageItemCount, usageHours, usageFrequency, reminderStartDate, reminderEndDate) { 
        
        ReminderDTO.initialize(this, medicineBarcode, medicineName, usageItemCount, usageHours, usageFrequency, reminderStartDate, reminderEndDate);
    }
     ...
     */
    static initialize(obj, medicineBarcode, medicineName, usageItemCount, usageHours, usageFrequency, reminderStartDate, reminderEndDate) { 
...
ReminderDTO.RequiredProperties = ["medicineBarcode", "medicineName", "usageItemCount", "usageHours", "usageFrequency", "reminderStartDate", "reminderEndDate"];
