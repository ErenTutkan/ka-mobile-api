...
class ReminderDTO {
     ...
     * @param sourceType {module:model/ReminderDTO.SourceTypeEnum} Source type.  Must be Medicine or Retail. Default value is Retail
     */
    constructor(medicineBarcode, medicineName, usageItemCount, usageHours, usageFrequency, reminderStartDate, reminderEndDate, sourceType) { 
        
        ReminderDTO.initialize(this, medicineBarcode, medicineName, usageItemCount, usageHours, usageFrequency, reminderStartDate, reminderEndDate, sourceType);
    }
     ...
     */
    static initialize(obj, medicineBarcode, medicineName, usageItemCount, usageHours, usageFrequency, reminderStartDate, reminderEndDate, sourceType) { 
...
ReminderDTO.RequiredProperties = ["medicineBarcode", "medicineName", "usageItemCount", "usageHours", "usageFrequency", "reminderStartDate", "reminderEndDate", "sourceType"];
 ...
 * @member {module:model/ReminderDTO.SourceTypeEnum} sourceType
 * @default 'Retail'
 */
ReminderDTO.prototype['sourceType'] = 'Retail';

/**
 * medicine image url
 * @member {String} imageUrl
 */
ReminderDTO.prototype['imageUrl'] = undefined;
