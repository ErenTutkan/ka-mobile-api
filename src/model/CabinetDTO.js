...
class CabinetDTO {
     ...
     */
    constructor(id, userId, medicineBarcode, medicineName, packType, packCount, expireDate, comment, isActive, remainingDays, isExpired) { 
        
        CabinetDTO.initialize(this, id, userId, medicineBarcode, medicineName, packType, packCount, expireDate, comment, isActive, remainingDays, isExpired);
    }
     ...
     */
    static initialize(obj, id, userId, medicineBarcode, medicineName, packType, packCount, expireDate, comment, isActive, remainingDays, isExpired) { 
        obj['id'] = id;
        obj['userId'] = userId;
...
CabinetDTO.RequiredProperties = ["id", "userId", "medicineBarcode", "medicineName", "packType", "packCount", "expireDate", "comment", "isActive", "remainingDays", "isExpired"];
