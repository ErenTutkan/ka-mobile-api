...
class CabinetDTO {
     ...
     */
    constructor(medicineBarcode, medicineName, packCount, expireDate) { 
        
        CabinetDTO.initialize(this, medicineBarcode, medicineName, packCount, expireDate);
    }
     ...
     */
    static initialize(obj, medicineBarcode, medicineName, packCount, expireDate) { 
...
CabinetDTO.RequiredProperties = ["medicineBarcode", "medicineName", "packCount", "expireDate"];
