...
class BloodPressureDTO {
     ...
     */
    constructor(id, userId, measurementDate, big, small, pulse, bodyPosition, period, tag, note) { 
        
        BloodPressureDTO.initialize(this, id, userId, measurementDate, big, small, pulse, bodyPosition, period, tag, note);
    }
     ...
     */
    static initialize(obj, id, userId, measurementDate, big, small, pulse, bodyPosition, period, tag, note) { 
        obj['id'] = id;
        obj['userId'] = userId;
...
BloodPressureDTO.RequiredProperties = ["id", "userId", "measurementDate", "big", "small", "pulse", "bodyPosition", "period", "tag", "note"];
