...
class BloodPressureDTO {
     ...
     */
    constructor(measurementDate, big, small, pulse, bodyPosition, period, tag, note) { 
        
        BloodPressureDTO.initialize(this, measurementDate, big, small, pulse, bodyPosition, period, tag, note);
    }
     ...
     */
    static initialize(obj, measurementDate, big, small, pulse, bodyPosition, period, tag, note) { 
...
BloodPressureDTO.RequiredProperties = ["measurementDate", "big", "small", "pulse", "bodyPosition", "period", "tag", "note"];
