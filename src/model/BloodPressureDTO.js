...
class BloodPressureDTO {
     ...
     * @param scaleCaption {String} scaleCaption
     * @param scaleValue {Number} scaleValue
     */
    constructor(id, userId, measurementDate, big, small, pulse, bodyPosition, period, tag, note, scaleCaption, scaleValue) { 
        
        BloodPressureDTO.initialize(this, id, userId, measurementDate, big, small, pulse, bodyPosition, period, tag, note, scaleCaption, scaleValue);
    }
     ...
     */
    static initialize(obj, id, userId, measurementDate, big, small, pulse, bodyPosition, period, tag, note, scaleCaption, scaleValue) { 
        obj['id'] = id;
        obj['userId'] = userId;
...
BloodPressureDTO.RequiredProperties = ["id", "userId", "measurementDate", "big", "small", "pulse", "bodyPosition", "period", "tag", "note", "scaleCaption", "scaleValue"];
