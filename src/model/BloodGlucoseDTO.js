...
class BloodGlucoseDTO {
     ...
     */
    constructor(id, userId, measurementDate, glucoseValue, hungryStatus, tag, note, scaleCaption, scaleValue) { 
        
        BloodGlucoseDTO.initialize(this, id, userId, measurementDate, glucoseValue, hungryStatus, tag, note, scaleCaption, scaleValue);
    }
     ...
     */
    static initialize(obj, id, userId, measurementDate, glucoseValue, hungryStatus, tag, note, scaleCaption, scaleValue) { 
        obj['id'] = id;
        obj['userId'] = userId;
...
BloodGlucoseDTO.RequiredProperties = ["id", "userId", "measurementDate", "glucoseValue", "hungryStatus", "tag", "note", "scaleCaption", "scaleValue"];
