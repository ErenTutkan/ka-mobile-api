...
class BloodGlucoseDTO {
     ...
     */
    constructor(id, userId, measurementDate, glucoseValue, hungryStatus, tag, note) { 
        
        BloodGlucoseDTO.initialize(this, id, userId, measurementDate, glucoseValue, hungryStatus, tag, note);
    }
     ...
     */
    static initialize(obj, id, userId, measurementDate, glucoseValue, hungryStatus, tag, note) { 
        obj['id'] = id;
        obj['userId'] = userId;
...
BloodGlucoseDTO.RequiredProperties = ["id", "userId", "measurementDate", "glucoseValue", "hungryStatus", "tag", "note"];
