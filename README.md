...
- API version: v4.0.0.7
- Package version: v4.0.0.7
...
*KolayAsistanMobileApi.MedicineRecipeApi* | [**recipeControllerFindUserMedicines**](docs/MedicineRecipeApi.md#recipeControllerFindUserMedicines) | **GET** /recipe | Find User Recipes
...
## Documentation for Models
 ...
 - [KolayAsistanMobileApi.DoctorDTO](docs/DoctorDTO.md)
 - [KolayAsistanMobileApi.MedicineDTO](docs/MedicineDTO.md)
 - [KolayAsistanMobileApi.MedicineDTOPharmacy](docs/MedicineDTOPharmacy.md)
 - [KolayAsistanMobileApi.PharmacyDTO](docs/PharmacyDTO.md)
 - [KolayAsistanMobileApi.RecipeDTO](docs/RecipeDTO.md)
 - [KolayAsistanMobileApi.RecipeDTODoctor](docs/RecipeDTODoctor.md)
