...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KolayAsistanMobileApi.RecipeDTODoctor();
  });
  ...
  describe('RecipeDTODoctor', function() {
    it('should create an instance of RecipeDTODoctor', function() {
      // uncomment below and update the code to test RecipeDTODoctor
      //var instance = new KolayAsistanMobileApi.RecipeDTODoctor();
      //expect(instance).to.be.a(KolayAsistanMobileApi.RecipeDTODoctor);
    });
